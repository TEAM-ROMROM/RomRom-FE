...
**Chores**
- 여러 워크플로우가 \"CHANGELOG 자동 업데이트\" 완료 시 자동 실행되도록 트리거 추가
- 워크플로우 메시지 안내 문구 간소화
- pubspec.yaml 버전 1.1.22+1.1.0으로 업데이트
- CHANGELOG 및 메타데이터 최신 릴리즈 정보 반영
...
**Chores**
- 워크플로우가 \"CHANGELOG 자동 업데이트\" 완료 시 자동으로 실행되도록 여러 배포 및 파일 업로드 작업의 트리거가 추가되었습니다.
- pubspec.yaml의 버전이 1.1.21+1.1.0으로 업데이트되었습니다.
- 워크플로우 내 일부 안내 문구가 더 간결하게 수정되었습니다.
