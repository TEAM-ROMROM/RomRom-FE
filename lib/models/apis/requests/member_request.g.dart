...
MemberRequest _$MemberRequestFromJson(Map<String, dynamic> json) => MemberRequest(
  member: json['member'] == null ? null : Member.fromJson(json['member'] as Map<String, dynamic>),
  preferredCategories: (json['preferredCategories'] as List<dynamic>?)?.map((e) => (e as num).toInt()).toList(),
...
Map<String, dynamic> _$MemberRequestToJson(MemberRequest instance) => <String, dynamic>{
