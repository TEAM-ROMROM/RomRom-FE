...
ChatRoomResponse _$ChatRoomResponseFromJson(Map<String, dynamic> json) => ChatRoomResponse(
  chatRoom: json['chatRoom'] == null ? null : ChatRoom.fromJson(json['chatRoom'] as Map<String, dynamic>),
  messages: json['messages'] == null ? null : PagedChatMessage.fromJson(json['messages'] as Map<String, dynamic>),
