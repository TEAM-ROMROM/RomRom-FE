...
MemberLocation _$MemberLocationFromJson(Map<String, dynamic> json) => MemberLocation(
...
Map<String, dynamic> _$MemberLocationToJson(MemberLocation instance) => <String, dynamic>{
